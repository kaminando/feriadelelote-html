    <?php require_once 'header.php'; ?>
        ...
        <main id="content" class="site-content instagram">
            <section class="site-banner banner-6 cover-bg relative" style="background-image: url(img/banner/banner-7.jpg);">
                <div class="overlay" data-bg-color="#000" data-opacity="0.8"></div>
                <div class="container">
                    <div class="row flex flex-middle flex-center fullscreen">
                        <div class="col-xs-12 col-md-8">
                            <div class="banner-7-content text-center">
                                <p class="text-light">Lorem ipsum dolor sit amet, consectetur adipisicing <br class="hidden-xs">elit, seddo eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim .</p>
                                <h2 class="primary-color text-uppercase mt-5 mb-20" style="background-image: url('img/banner/banner-7.jpg');">Fireworks Event</h2>
                                <div class="event-countdown transparent inline-flex flex-center oswald primary-bg text-light mb-20"></div>
                                <div class="clear"></div>
