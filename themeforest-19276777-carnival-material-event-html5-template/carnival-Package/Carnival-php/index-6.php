    <?php require_once 'header.php'; ?>
        ...
        <main id="content" class="site-content instagram">
            <section class="site-banner banner-6 cover-bg relative" style="background-image: url(img/banner/banner-6.jpg);">
                    ...
                    <div class="row flex flex-middle fullscreen">
                        <div class="col-xs-12 col-md-8">
                            <div class="banner-3-content">
                                ...
                                <h2 class="primary-color text-uppercase mt-5 mb-10">Music in my mind Event</h2>
                                <p class="text-light">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                                <a href="#" class="btn btn-white-border-tp btn-wide text-uppercase">Book Your Seat</a>
                                <a href="#" class="btn btn-white-border-tp btn-wide text-uppercase ml-10">Learn More</a>
                            </div>
                        </div>
                    </div> <!-- // .row -->
                </div> <!-- // .container -->
                <div class="booking-form-container">
                    <div class="container relative">
                        <a href="javascript:;" class="toggle-form">
                            <i class="cpi cpi-caret-down"></i>
                        </a>
                        <form action="#" class="booking-form row flex flex-middle disable-flex-xs">
                            ...
                            <div class="col-xs-12 col-6 col-md-2">
                                <div class="input-group">
                                    <select name="" id="" class="selectize selectize-tp">
                            ...
                            <div class="col-xs-12 col-6 col-md-2">
                                <div class="input-group">
                                    <button class="btn btn-theme btn-wide w100 text-uppercase">Submit Request</button>
                                </div>
                            </div>
                        </form> <!-- end .row -->
                    </div> <!-- end .container -->
                ...
                <div class="container">
                    ...
                    <div class="row event-schedule">
                        ...
                        <div class="tab-content col-xs-12  col-lg-offset-1 col-lg-10">
                            <div id="opening-day" class="tab-pane fade in active">
                                <div class="table-responsive default-shadow">
                                  <!-- Table -->
                                    <table class="mm-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-uppercase">Speaker</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Michelle Goodwin</td>
                                                <td>08.30 am</td>
                                                <td>Main Hall Room</td>
                                            </tr>
                                            <tr>
                                                <td>02</td>
                                                <td>Opening Remarks</td>
                            ...
                            <div id="next-day" class="tab-pane fade">
                                <div class="table-responsive default-shadow">
                                  <!-- Table -->
                                    <table class="mm-table">
                                        <thead>
                            ...
                            <div id="last-day" class="tab-pane fade">
                                <div class="table-responsive default-shadow">
                                  <!-- Table -->
                                    <table class="mm-table">
                                        <thead>
