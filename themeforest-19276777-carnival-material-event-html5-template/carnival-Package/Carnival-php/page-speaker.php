    <?php require_once 'header.php'; ?>
        ...
        <main id="content" class="site-content instagram">
            ...
            <div class="page-header relative" data-bg-color="#01040e">
                <div class="page-header-flap cover-bg" style="background-image: url('img/banner/breadcrumb-bg.png');" data-opacity="0.4"></div>
                <div class="container">
                    <div class="page-header-inner text-center">
                        <h2 class="h1 page-title text-light text-uppercase">Speakers</h2>
                        <ul class="breadcrumbs fz-16 flex flex-center">
                            <li><a href="./">Home</a></li>
                            <li><i class="cpi cpi-long-arrow-right"></i></li>
                            <li>Speakers</li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-lg-offset-1 col-lg-10">
                            <div class="row flex flex-middle disable-flex-xs">
                                <div class="col-sx-12 col-sm-4 col-md-4 text-center mb-xs-30">
            ...
            <!-- speaker  -->
            <section class="section top-full relative">
                <div class="container">
                    <div class="row">
